jQuery(function(t) {
    if ("undefined" == typeof fs_add_to_cart_params) return !1;
    var a = function() {
        this.requests = [], this.addRequest = this.addRequest.bind(this), this.run = this.run.bind(this), t(document.body).on("click", ".add_to_cart_button:not(.fs-interactive)", {
    ...
    a.prototype.addRequest = function(t) {
        ...
        if (e.is(".ajax_add_to_cart")) {
            ...
            var r = {'csrfmiddlewaretoken':csrfmiddlewaretoken, 'action':'ajax_add_to_cart'};
            t.each(e.data(), function(t, a) {
                ...
                type: "POST",
                url: fs_add_to_cart_params.fs_ajax_url.toString().replace("%%endpoint%%", "add_to_cart"),
                data: r,
                success: function(a) {
                    a && (a.error && a.product_url ? window.location = a.product_url : "yes" !== fs_add_to_cart_params.cart_redirect_after_add ? t(document.body).trigger("added_to_cart", [a.fragments, a.cart_hash, e]) : window.location = fs_add_to_cart_params.cart_url)
                },
                dataType: "json"
            })
        }
        ...
        var e = t(this),
            r = e.closest(".site_front-mini-cart-item");
        a.preventDefault(), r.block({
            ...
            type: "POST",
            url: fs_add_to_cart_params.fs_ajax_url.toString().replace("%%endpoint%%", "remove_from_cart"),
            data: {
        ...
        (d = void 0 !== d && d) && (d.removeClass("loading"), e && d.addClass("added"), e && !fs_add_to_cart_params.is_cart && 0 === d.parent().find(".added_to_cart").length && d.after('<a href="' + fs_add_to_cart_params.cart_url + '" class="added_to_cart fs-forward" title="' + fs_add_to_cart_params.i18n_view_cart + '">' + fs_add_to_cart_params.i18n_view_cart + "</a>"), t(document.body).trigger("fs_cart_button_updated", [d]))
        ...
        }), t(document.body).trigger("fs_fragments_loaded"))
    }, new a
});